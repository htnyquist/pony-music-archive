...
from utils.clean_print import print_clean
...
class BandcampDownloader:
    ...
    def download_album(self, album: dict) -> bool:
        ...
        if os.path.isfile("{}/not.finished".format(self.directory)):
            os.remove("{}/not.finished".format(self.directory))
